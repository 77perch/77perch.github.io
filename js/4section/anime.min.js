(function (u, r) {
    ...
    var u = {
            ...
            update: void 0,
            complete: void 0
        }, r = "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "), y, f = {
            arr: function (a) {
            ...
            var a = {}, b = {
                Sine: function (a) {
                    ...
                    if (0 === a || 1 === a)return a;
                    var d = 1 - Math.min(b, 998) / 1E3, g = a / 1 - 1;
            ...
            ["Quad",
                "Cubic", "Quart", "Quint", "Expo"].forEach(function (a, e) {
                b[a] = function (a) {
        ...
        T = function (a) {
            ...
            var b = parseInt(a[1]) / 360, c = parseInt(a[2]) / 100, e = parseInt(a[3]) / 100;
            a = function (a, b, c) {
                0 > c && (c += 1);
                1 < c && --c;
                return c < 1 / 6 ? a + 6 * (b - a) * c : .5 > c ? b : c < 2 / 3 ? a + (b - a) * (2 / 3 - c) * 6 : a
            };
            if (0 == c)c = e = b = e; else var d = .5 > e ? e * (1 + c) : e + c - e * c, g = 2 * e - d, c = a(g, d, b + 1 / 3), e = a(g, d, b), b = a(g, d, b - 1 / 3);
            ...
            var c = -1 < b.indexOf("scale") ? 1 : 0, e = a.style.transform;
            if (!e)return c;
            ...
            a.forEach(function (e, d) {
                ...
                return b.forEach(function (b) {
                    ...
                    if (l) {
                        var q;
                        q = b.name;
                        var h = b.value, h = t(f.fnc(h) ? h(g, d) : h);
            ...
            a.tweens.forEach(function (c) {
                var e = c.from, d = a.duration - (c.delay + c.duration);
                c.from = c.to;
                c.to = e;
                b && (c.delay = d)
            });
            ...
            var c = a.path, e = a.value * b, d = function (d) {
                d = d || 0;
            ...
            var c = Math.min(Math.max(b - a.delay, 0), a.duration) / a.duration, e = a.to.numbers.map(function (b, e) {
                var f = a.from.numbers[e], l = D[a.easing](c, a.elasticity), f = a.path ? ca(a, l) : f + l * (b - f);
            ...
            for (var e = 0; e < a.tweens.length; e++) {
                ...
                for (var f = d.currentValue, m = 0; m < d.animatables.length; m++) {
                    var l =
                        d.animatables[m], k = l.id, l = l.target, h = d.name;
                    switch (d.type) {
                        case "css":
                            l.style[h] = f;
                            break;
            ...
            b.settings = v(a, u);
            var c = b.settings, e = [], d;
            for (d in a)if (!u.hasOwnProperty(d) &&
                "targets" !== d) {
